...
/**
 * @summary Record the result of a completed shift
 */
...
export type CreateShiftMutationError = ErrorType<ErrorEnvelope>;
...
/**
 * @summary Get the authenticated user's shift history
 */
...
export const getShifts = async (
  ...
  return customFetch<ShiftListResponse>(getGetShiftsUrl(), {
    ...options,
    method: "GET",
  });
};
...
export type GetShiftsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getShifts>>
>;
export type GetShiftsQueryError = ErrorType<ErrorEnvelope>;
